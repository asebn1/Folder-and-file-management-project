...
// ------------------------Display ---------------------------
	...
	*	@return	상관없이 1 반환.
	*/
	int RetrieveFolderByName(string temp, int num, FolderType &Ft);
	...
	*	@return	상관없이 1 반환.
	*/
	int RetrieveFileByName(string temp);
	...
	*/
	void NewfList(string temp) {
		fList = new SinglyLinkedList<FolderType>;
	}
...
protected:
	...
	SinglyLinkedList<FolderType> *fList; // SinglyLinkedList로 구현
	SinglyLinkedList<FileType> *fileList; // SinglyLinkedList로 구현
