...
void Application::RetrieveFolderByName()
{
	...
	cout << "\t\t      [검색 결과]" << endl;
	cout << "\t---------------------------------------" << endl;
	m_RootFolder.RetrieveFolderByName(s, m_RootFolder.GetSubFolderNum(), m_RootFolder);
	cout << "\t---------------------------------------" << endl;
}
...
// 파일 이름으로 검색
void Application::RetrieveFileByName() {
	string s;
	cout << "\t 검색명 : ";
	cin >> s;
	cout << "\t\t      [검색 결과]" << endl;
	cout << "\t---------------------------------------" << endl;
	m_RootFolder.RetrieveFileByName(s);
	cout << "\t---------------------------------------" << endl;
}
